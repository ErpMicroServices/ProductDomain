...
public class DatabaseSetupSteps {
    ...
    public void aCleanPostgreSQLDatabaseInstance() throws SQLException {
        ...
        // This step is specific to PostgreSQL compatibility tests
        // For H2 tests, this will be skipped
    ...
    public void postgreSQLSpecificOptimizationsAreEnabled() throws SQLException {
        ...
        // Skip this step for H2 database
        if ("H2".equals(databaseProductName)) {
            return; // This step is only relevant for PostgreSQL tests
        }
    ...
    public void iQueryTheDatabaseMetadata() throws SQLException {
        ...
        // Accept both H2 and PostgreSQL
        assertTrue("H2".equals(databaseProductName) || "PostgreSQL".equals(databaseProductName), 
                  "Should be H2 or PostgreSQL, found: " + databaseProductName);
    }
    ...
    public void theDatabaseShouldBeUsingPostgreSQLVersion(String expectedVersion) throws SQLException {
        ...
        // Skip version check for H2
        if ("H2".equals(databaseProductName)) {
            return; // Version check is only relevant for PostgreSQL
        }
